...
export class CategoriaInformacionServicio {
    ...
    static async listarCategoriasInformaciones(req: ServerRequest, ordenarPor: string, ordenarModo:OrderModeEnum, tamanoPagina: number, indicePagina: number): Promise<any> {
        try{
