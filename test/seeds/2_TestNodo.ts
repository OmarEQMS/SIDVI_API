...
export const seed = async (knex: Knex) => {
	await knex('TestNodo').insert([
		{ idTestNodo:1, fkVirus: 1, texto: 'Nodo 1', descripcion: 'Descripcion', mimetype: ContentTypeEnum.PDF, archivo: fs.readFileSync(path.resolve(__dirname, '..', 'files', 'archivoPdf1.pdf')) } as ITestNodo,
